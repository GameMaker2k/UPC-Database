...
if (($_GET['act'] == "join" || $_GET['act'] == "signup") &&
    ...
    if ($usersid == 1) {
        sqlite3_query($slite3, "UPDATE \"".$table_prefix."members\" SET \"validated\"='yes',\"validateitems\"='no',\"admin\"='yes' WHERE \"name\"='".sqlite3_escape_string($slite3, $_POST['username'])."' AND \"id\"=1;");
    }
